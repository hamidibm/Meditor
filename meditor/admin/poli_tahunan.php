...
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <h1 class="title">Kunjungan Poli Tahunan</h1>
            <ul class="breadcrumbs">
                ...
                <li class="divider">/</li>
                <li><a href="poli_tahunan.php" class="active">Tahunan</a></li>
            </ul>
            ...
            <div class="data">
                <div class="content-data">
                    <div class="head">
                        <h3>Data Kunjungan Tahun ini</h3>
                    </div>
                    <div class="panel ">

                        <div class="panel-body"><iframe src="../assets/chartjs/barchartsjspolitahunan.php" width="100%" height="320"></iframe></div>
                    </div>
                </div>
            </div>
        </main>
