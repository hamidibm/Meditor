...
$data = query("SELECT p.poli,
                        (SELECT COUNT(*) 
                            FROM berobat b
                            WHERE b.poli = p.poli
                            AND MONTH(CURDATE()) = MONTH(b.tgl_berobat)
					        AND YEAR(CURDATE()) = YEAR(b.tgl_berobat)
...
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <h1 class="title">Kunjungan Poli Bulanan</h1>
            ...
            <ul class="breadcrumbs">
                ...
                <li><a href="poli_harian.php">Harian</a></li>
                <li class="divider">/</li>
                <li><a href="poli_bulanan.php" class="active">Bulanan</a></li>
                <li class="divider">/</li>
            ...
            <div class="data">
                <div class="content-data">
                    <div class="head">
                        <h3>Data Kunjungan Poli Bulan ini</h3>
                    </div>
                    <div class="panel ">

                        <div class="panel-body"><iframe src="../assets/chartjs/barchartsjspolibulanan.php" width="100%" height="320"></iframe></div>
                    </div>
                </div>
            </div>
        </main>
