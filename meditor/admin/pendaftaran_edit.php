				...
				<div>
					<form method="POST">
						...
						<div class="row mb-3">
							...
							<div class="col-sm-10">
								<input name="nik" value="<?= $data["nik"]; ?>" type="number" class="form-control" id="inputnama">
							</div>
						</div>
						...
						<div class="row mb-3">
							...
							<div class="col-sm-10">
								<input name="nama" value="<?= $data["nama"]; ?>" type="text" class="form-control" id="inputnik">
							</div>
						</div>
						...
						<div class="row mb-3">
							...
							<div class="col-sm-10">
								<input name="alamat" value="<?= $data["alamat"]; ?>" type="text" class="form-control" id="inputalamat">
							</div>
						</div>
